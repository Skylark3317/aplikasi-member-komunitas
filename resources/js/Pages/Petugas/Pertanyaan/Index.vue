  ...
  <PetugasLayout>
    ...
    <div class="content-area">
      ...
      <div v-else class="question-list">
        <div v-for="conv in conversations" :key="conv.id" class="question-card">
      ...
      <!-- Pagination Placeholder (matched to screenshot UI) -->
      <div class="pagination" v-if="conversations.length > 5">
        <button class="page-btn text-muted"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 18 9 12 15 6"></polyline></svg> Sebelumnya</button>
        <button class="page-btn active">1</button>
        <button class="page-btn">2</button>
        <button class="page-btn">3</button>
        <button class="page-btn text-primary">Berikutnya <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
      </div>
    </div>
  </PetugasLayout>
</template>
