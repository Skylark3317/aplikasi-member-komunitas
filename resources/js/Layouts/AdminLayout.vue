  ...
  <div class="admin-wrapper">
    ...
    <aside class="sidebar ">
      ...
      <nav class="sidebar-nav">
        ...
        <Link
          :href="route('superadmin.paket-premium.index')"
          :class="['nav-item', isActive('superadmin.paket-premium') ? 'active' : '']"
        >
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
        ...
        <Link
          ...
          :class="['nav-item', isActive('superadmin.riwayat-aktivitas') ? 'active' : '']"
        >
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
