    ...
    <aside class="sidebar" :class="{ 'sidebar-open': sidebarOpen }">
      ...
      <nav class="sidebar-nav">
        ...
        <div class="sub-nav">
          ...
          <Link :href="route('ketua.statistik.detail', { type: 'member' })" :class="['sub-nav-item', isDetailType('member') ? 'active' : '']" @click="sidebarOpen = false">Member</Link>
          <Link :href="route('ketua.statistik.detail', { type: 'konten' })" :class="['sub-nav-item', isDetailType('konten') ? 'active' : '']" @click="sidebarOpen = false">Konten</Link>
          <Link :href="route('ketua.statistik.detail', { type: 'blog' })" :class="['sub-nav-item', isDetailType('blog') ? 'active' : '']" @click="sidebarOpen = false">Blog</Link>
          <Link :href="route('ketua.statistik.detail', { type: 'pertanyaan' })" :class="['sub-nav-item', isDetailType('pertanyaan') ? 'active' : '']" @click="sidebarOpen = false">Pertanyaan</Link>
          <Link :href="route('ketua.statistik.detail', { type: 'payment' })" :class="['sub-nav-item', isDetailType('payment') ? 'active' : '']" @click="sidebarOpen = false">Pendapatan</Link>
        </div>
      ...
      <div class="sidebar-user" @click="togglePopup" ref="userBtn">
        ...
        <div v-if="showPopup" class="user-popup" @click.stop>
          <Link :href="route('ketua.profil')" class="popup-item" @click="showPopup = false; sidebarOpen = false">
...
@media (max-width: 1024px) {
  ...
  .mobile-logo-img { max-height: 32px; object-fit: contain; }
  ...
  /* Show overlay */
  .sidebar-overlay.d-block { display: block; }
}
</style>